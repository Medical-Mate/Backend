 ...
 *
 * <p>값은 가짜지만 <b>모양은 진짜여야 한다</b> — 홈페이지가 없는 병원을 섞어 둔 이유다.
 * 작은 의원은 대부분 {@code hospUrl} 이 비어 있다.
 */
public class StubHospitalSearchClient implements HospitalSearchClient {

    private static final List<Hospital> FIXTURES = List.of(
            new Hospital("서울대학교병원", "http://www.snuh.org"),
            new Hospital("분당서울대학교병원", "http://www.snubh.org/index.do"),
            new Hospital("연세세브란스병원", "http://www.severance.healthcare"),
            // 홈페이지가 없는 경우. 화면이 이 상태를 견뎌야 한다.
